Shader "Custom/220914_MixImg"
{
    /*
    A이미지에서 B이미지로 부드럽게 이동하기
    */
    Properties
    {
    ...
    SubShader
    {
        ...
        half _Metallic;
        fixed4 _Color;
        half _Ratio;  //이미지 2개 섞을 때 비율용 변수
        half _Ratio2;
        ...
        void surf (Input IN, inout SurfaceOutputStandard o)
        {
            ...
            o.Albedo = lerp(c1.rgb, c2.rgb, _Ratio);    // 이미지 2개 섞는 것
            o.Albedo = lerp(o.Albedo, c3.rgb, _Ratio2); // 그 결과물로 이미지 섞음.
